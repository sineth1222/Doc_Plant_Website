    ...
    <>
              ...
              <span id="potato_late_bright"></span>
                <div className="py-10">
                  ...
                  <p className="mb-5 text-sm text-gray-500 group-hover:text-white duration-high">
                  The effect of disease on the potato crop may sometimes be considerable. Phytophthora infestans can cause severe damage to potato crops by affecting the following:
                  ...
                  <p className="mb-5 text-sm text-gray-500 group-hover:text-white duration-high">
                  ✅ Use Resistant Varieties – Some potato cultivars have resistance to late blight (e.g., Russet Burbank, Defender).
                  </p>
                  <p className="mb-5 text-sm text-gray-500 group-hover:text-white duration-high">
...
export default Potato_late_bright
